unit UfrmPreviewReporteArchivosPorCarneIdentidad;
...
type
  TfrmPreviewReporteArchivosPorCarneIdentidad = class(TForm)
    Preview: TQRPreview;
    EXQR: TExportQR;
...
var
  frmPreviewReporteArchivosPorCarneIdentidad: TfrmPreviewReporteArchivosPorCarneIdentidad;
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBSaveClick(Sender: TObject);
begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteArchivosPorCarneIdentidad.Caption:= 'HostalWare. Vista Previa. Exportando el Reporte de Archivos a PDF. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteArchivosPorCarneIdentidad.Caption:= 'HostalWare. Vista Previa del Reporte de Archivos. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
            if (IdiomaImperante = 'Ingles')
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBPrintClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBExitClick(Sender: TObject);
begin
  Close;
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBPrimeroClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBZoomToFitClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBZoomToWidthClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBAumentarZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBReducirZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBUltimoClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBSiguienteClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.TBAnteriorClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidad.PreviewPageAvailable(Sender: TObject; PageNum: Integer);
begin
