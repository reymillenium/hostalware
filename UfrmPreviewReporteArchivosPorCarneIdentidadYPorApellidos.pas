unit UfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos;
...
type
  TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos = class(TForm)
    Preview: TQRPreview;
    EXQR: TExportQR;
...
var
  frmPreviewReporteArchivosPorCarneIdentidadYPorApellidos: TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos;
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBSaveClick(Sender: TObject);
begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.Caption:= 'HostalWare. Vista Previa. Exportando el Reporte de Archivos a PDF. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.Caption:= 'HostalWare. Vista Previa del Reporte de Archivos. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
            if (IdiomaImperante = 'Ingles')
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBPrintClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBExitClick(Sender: TObject);
begin
  Close;
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBPrimeroClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBZoomToFitClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBZoomToWidthClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBAumentarZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBReducirZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBUltimoClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBSiguienteClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.TBAnteriorClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorCarneIdentidadYPorApellidos.PreviewPageAvailable(Sender: TObject; PageNum: Integer);
begin
