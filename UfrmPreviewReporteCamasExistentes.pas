unit UfrmPreviewReporteCamasExistentes;
...
type
  TfrmPreviewReporteCamasExistentes = class(TForm)
    Preview: TQRPreview;
    EXQR: TExportQR;
...
var
  frmPreviewReporteCamasExistentes: TfrmPreviewReporteCamasExistentes;
...
procedure TfrmPreviewReporteCamasExistentes.TBSaveClick(Sender: TObject);
begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteCamasExistentes.Caption:= 'HostalWare. Vista Previa. Exportando el Reporte de Camas Existentes a PDF. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteCamasExistentes.Caption:= 'HostalWare. Vista Previa del Reporte de Camas Existentes. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
            if (IdiomaImperante = 'Ingles')
...
procedure TfrmPreviewReporteCamasExistentes.TBPrintClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteCamasExistentes.TBExitClick(Sender: TObject);
begin
  Close;
...
procedure TfrmPreviewReporteCamasExistentes.TBPrimeroClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteCamasExistentes.TBZoomToFitClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteCamasExistentes.TBZoomToWidthClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteCamasExistentes.TBAumentarZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteCamasExistentes.TBReducirZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteCamasExistentes.TBUltimoClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteCamasExistentes.TBSiguienteClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteCamasExistentes.TBAnteriorClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteCamasExistentes.PreviewPageAvailable(
