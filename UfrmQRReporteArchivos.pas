...
type
  TQuickReportArchivos = class(TQuickRep)
...
var
  QuickReportArchivos: TQuickReportArchivos;

implementation
Uses
  UfrmPreviewReporteArchivos;
{$R *.DFM}



procedure TQuickReportArchivos.QuickRepPreview(Sender: TObject);
begin
  //Le mando al printer del Preview la información de este mismo reporte
  frmPreviewReporteArchivos.Preview.QRPrinter := QuickReportArchivos.QRPrinter;

  //Mando a que se muestre el Preview
  frmPreviewReporteArchivos.Position:= poDesktopCenter;
  frmPreviewReporteArchivos.ShowModal;
end;
