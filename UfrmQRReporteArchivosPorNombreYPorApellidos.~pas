unit UfrmQRReporteArchivosPorNombreYPorApellidos;
...
type
  TQuickReportArchivosPorNombreYPorApellidos = class(TQuickRep)
...
var
  QuickReportArchivosPorNombreYPorApellidos: TQuickReportArchivosPorNombreYPorApellidos;
...
procedure TQuickReportArchivosPorNombreYPorApellidos.QuickRepPreview(Sender: TObject);
begin
  //Le mando al printer del Preview la información de este mismo reporte
  frmPreviewReporteArchivosPorNombreYPorApellidos.Preview.QRPrinter := QuickReportArchivosPorNombreYPorApellidos.QRPrinter;

  //Mando a que se muestre el Preview
  frmPreviewReporteArchivosPorNombreYPorApellidos.Position:= poDesktopCenter;
  frmPreviewReporteArchivosPorNombreYPorApellidos.ShowModal;
end;
