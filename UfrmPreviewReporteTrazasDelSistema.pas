...
begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteTrazasDelSistema.Caption:= 'HostalWare. Vista Previa. Exportando el Reporte de Trazas del Sistema a PDF. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteTrazasDelSistema.Caption:= 'HostalWare. Vista Previa del Reporte de Trazas del Sistema. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
            if (IdiomaImperante = 'Ingles')
      ...
      begin
        ...
        if (Preview.QRPrinter.PageCount = 0)
          then
            begin
              //Especifico la posicion de pagina
              frmPreviewReporteTrazasDelSistema.Caption:= 'HostalWare. Vista Previa del Reporte de Trazas del Sistema. Página ' + IntToStr(Preview.PageNumber) + ' de 1';
            end
              else
                begin
                  //Especifico la posicion de pagina
        ...
        frmPreviewReporteTrazasDelSistema.Caption:= 'HostalWare. Vista Previa del Reporte de Trazas del Sistema. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
          ...
          begin
            if (IdiomaImperante = 'Ingles')
              then
                begin
                  frmPreviewReporteTrazasDelSistema.Caption:= 'HostalWare. Vista Previa del Reporte de Capacidades';
