unit UfrmPreviewReporteRegistroDeHuespedes;
...
type
  TfrmPreviewReporteRegistroDeHuespedes = class(TForm)
    Preview: TQRPreview;
    EXQR: TExportQR;
...
var
  frmPreviewReporteRegistroDeHuespedes: TfrmPreviewReporteRegistroDeHuespedes;
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBSaveClick(Sender: TObject);
begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteRegistroDeHuespedes.Caption:= 'HostalWare. Vista Previa. Exportando el Reporte de Registro de Huéspedes a PDF. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteRegistroDeHuespedes.Caption:= 'HostalWare. Vista Previa del Reporte de Registro de Huéspedes. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
            if (IdiomaImperante = 'Ingles')
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBPrintClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBExitClick(Sender: TObject);
begin
  Close;
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBPrimeroClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBZoomToFitClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBZoomToWidthClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBAumentarZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBReducirZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBUltimoClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBSiguienteClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteRegistroDeHuespedes.TBAnteriorClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteRegistroDeHuespedes.PreviewPageAvailable(Sender: TObject; PageNum: Integer);
begin
