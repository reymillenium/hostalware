unit UfrmPreviewReporteHabitacionesExistentes;
...
type
  TfrmPreviewReporteHabitacionesExistentes = class(TForm)
    Preview: TQRPreview;
    EXQR: TExportQR;
...
var
  frmPreviewReporteHabitacionesExistentes: TfrmPreviewReporteHabitacionesExistentes;
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBSaveClick(Sender: TObject);
begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteHabitacionesExistentes.Caption:= 'HostalWare. Vista Previa. Exportando el Reporte de Capacidades a PDF. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteHabitacionesExistentes.Caption:= 'HostalWare. Vista Previa del Reporte de Capacidades. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
            if (IdiomaImperante = 'Ingles')
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBPrintClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBExitClick(Sender: TObject);
begin
  Close;
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBPrimeroClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBZoomToFitClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBZoomToWidthClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBAumentarZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBReducirZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBUltimoClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBSiguienteClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteHabitacionesExistentes.TBAnteriorClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteHabitacionesExistentes.PreviewPageAvailable(
