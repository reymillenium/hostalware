unit UfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje;
...
type
  TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje = class(TForm)
    Preview: TQRPreview;
    EXQR: TExportQR;
...
var
  frmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje: TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje;
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBSaveClick(Sender: TObject);
begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.Caption:= 'HostalWare. Vista Previa. Exportando el Reporte de Archivos a PDF. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
  ...
  if (IdiomaImperante = 'Espannol')
    then
      begin
        frmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.Caption:= 'HostalWare. Vista Previa del Reporte de Archivos. Página ' + IntToStr(Preview.PageNumber) + ' de ' + IntToStr(Preview.QRPrinter.PageCount);
      end
        else
          begin
            if (IdiomaImperante = 'Ingles')
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBPrintClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBExitClick(Sender: TObject);
begin
  Close;
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBPrimeroClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBZoomToFitClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBZoomToWidthClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBAumentarZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBReducirZoomClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBUltimoClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBSiguienteClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.TBAnteriorClick(Sender: TObject);
begin
...
procedure TfrmPreviewReporteArchivosPorIntervalosDeFechasFinalHospedaje.PreviewPageAvailable(Sender: TObject; PageNum: Integer);
begin
